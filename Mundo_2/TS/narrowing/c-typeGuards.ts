...
function testar_type(par_valor: number | string): number {
...
let t_msg: (number | string) = testar_type("txt teste");
console.log(`O resultado da execução da função é: ${t_msg}`)

// ///////////////////////////////////////////////////////////////////

function testar_type2(par_valor2: number | string): number|string {
...
let msg: (number | string) = testar_type2("isto é um teste");
